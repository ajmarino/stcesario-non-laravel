<section id="about-us" class="flex flex-column bg-white" ref="about-us">
	<div class="center tc ph4 pv5 bg-white">
		<div class="bw3 bl br bd-dark-red mw5 center ph2">
			<h2 class="bg-dark-red ff-oswald f2 ttu white pv1">About Us</h2>
		</div>
	...
	<div class="bg-moon-gray">
		<div class="mw8 center pa4">
			<h3 class="f2 lh-copy">Here's what we do</h3>
			<p class="f3 lh-copy">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>

			<div class="flex justify-between">
				<div class="block block--service">
					<div class="block__icon">
						<i class="icon" style="display: block; height: 80px; width: 80px;">
							<img src="/images/icons/question-mark.svg" alt="" class="iconic iconic-fluid">
						</i>
					</div>
